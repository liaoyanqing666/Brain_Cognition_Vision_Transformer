# this is just a train.py template
import torch
...
for epoch in range(epochs):
    ...
    print(f'Epoch [{epoch+1}/{epochs}], Train Loss: {total_train_loss/len(train_dataset)},
           Test Loss: {total_test_loss/len(test_dataset)}, Lowest Test Loss: {lowest_test_loss}')
